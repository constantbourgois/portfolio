...
export default function Contact() {
    ...
    return (
        <div className="wrap-contact">
            <article>
                <span>+33 6 62 13 62 62 </span><span>constantbourgois@gmail.com</span>
                <div className="social-contact">
                    <a target="_blank"  href="https://fr.linkedin.com/in/constant-bourgois-02a77b11"><FontAwesomeIcon icon={faLinkedin}/>
                    </a>
                    <a target="_blank" href="https://github.com/constantbourgois"> <FontAwesomeIcon icon={faGithub} /></a>
                    <a target="_blank" href="https://www.malt.fr/profile/constantbourgois"><svg xmlns="http://www.w3.org/2000/svg" aria-label="Malt" role="img" viewBox="0 0 512 512"><rect width="512" height="512" rx="15%" fill="#ffffff"/>
